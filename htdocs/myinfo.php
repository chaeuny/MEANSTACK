...
if($_SESSION['userid']){
    ...
    $jb_sql = "SELECT num,id,pass,name,gender,phone,email FROM user WHERE id = '" . $userid . "';";
  ...
  //  while ( $jb_row = mysqli_fetch_array( $jb_result ) ) {
   ...
   // }
//
    //<br /><b>Notice</b>:  Undefined variable: bno in <b>C:\xampp\htdocs\myinfo.php</b> on line <b>42</b><br />
    $bno = $jb_row['num'];
  ?>  
		...
		<div class="container"> 
			...
			<div class="col-lg-4">
				<div class="jumbotron" style="padding-top: 20px;">
					<form name="join"  method="post" action="myinfo_ok.php">
						<h3 style="text-align: center"> 내 정보 수정 </h3>
						<div class="col-lg-4"></div>
						<div class="form-group">
							 <input type="hidden" class="form-control"  name="num" value="<?=$bno?>" />
