<?php
	...
	//$con = mysqli_connect("localhost","root","","hsh") or die(mysqli_connect_error());
			//					$name = $_REQUEST['name'];
			//					$image ="SELECT * FROM images WHERE name='$name'";
...
<?php 
	if(!empty($board['image_data'])){
									?>
						<tr>
							<td>image</td>
							<td colspan="2" style="min-height: 200px; text-align: center;"> 
								
							<?php	echo "<img src='data:image/jpeg;base64," . base64_encode($board['image_data']) . "' width='550' height='550' />"; 
				        } ?>
			...
			<div class="reply_view">
				...
				<div class="dat_ins">
					...
					<div style="margin-top:10px;">
						<textarea name="content" class="rep_con" id="rep_con"></textarea cols="50" rows="104">
						<button id="rep_btn" class="rep_btn" size="30">댓글</button>
					</div>
				</div>
			</div>
		</div>
